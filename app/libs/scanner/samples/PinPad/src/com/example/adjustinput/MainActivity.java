    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        disableStatuBar.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                byte[] reqBuf = "6225758326736419".getBytes();//卡号
                 ...
                 *密码支持的长度
                 *回调接口*/
                mp.getPinBlock(2, 3, reqBuf, reqBuf.length,
                        "请输入密码", 2 * 60 * 1000, mPedInputListener);//input pin 123456 return pinblock: 0AB91352CC8E633E
                /*mp.getPinBlockEx(2, 3, reqBuf, reqBuf.length,
    ...
    private PedInputListener mPedInputListener = new PedInputListener() {
        ...
        public void onChanged(int result, int keylen, byte[] keybuf) {
            ...
            if(result == 2) {
                ...
                Toast.makeText(MainActivity.this, " getPinBlock ==" + bytes2HexString(keybuf), Toast.LENGTH_SHORT).show();
